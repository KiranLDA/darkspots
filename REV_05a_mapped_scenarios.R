...
finalPlot1
# ggsave(paste0(basepath, "map_scenario_1_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p1
# ggsave(paste0(basepath, "roseplot_scenario_1_S_sc.pdf"), width = 15, height = 15, units = "cm")


ggarrange(map1,p1,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_1_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot2
# ggsave(paste0(basepath, "map_scenario_2_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p2
# ggsave(paste0(basepath, "roseplot_scenario_2_S_sc.pdf"), width = 15, height = 15, units = "cm")

ggarrange(map2,p2,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_2_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot3
# ggsave(paste0(basepath, "map_scenario_3_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p3
# ggsave(paste0(basepath, "roseplot_scenario_3_S_sc.pdf"), width = 15, height = 15, units = "cm")

ggarrange(map3,p3,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_3_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot4
# ggsave(paste0(basepath, "map_scenario_4_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p4
# ggsave(paste0(basepath, "roseplot_scenario_4_S_sc.pdf"), width = 15, height = 15, units = "cm")

ggarrange(map4,p4,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_4_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot5
# ggsave(paste0(basepath, "map_scenario_5_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p5
# ggsave(paste0(basepath, "roseplot_scenario_5_S_sc.pdf"), width = 15, height = 15, units = "cm")

ggarrange(map5,p5,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_5_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot6
# ggsave(paste0(basepath, "map_scenario_6_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p6
# ggsave(paste0(basepath, "roseplot_scenario_6_S_sc.pdf"), width = 15, height = 15, units = "cm")



ggarrange(map6,p6,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_6_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot7
# ggsave(paste0(basepath, "map_scenario_7_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p7
# ggsave(paste0(basepath, "roseplot_scenario_7_S_sc.pdf"), width = 15, height = 15, units = "cm")



ggarrange(map7,p7,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_7_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot8
# ggsave(paste0(basepath, "map_scenario_8_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p8
# ggsave(paste0(basepath, "roseplot_scenario_8_S_sc.pdf"), width = 15, height = 15, units = "cm")



ggarrange(map8,p8,ncol = 2, nrow = 1, widths = c(1, 0.5))
ggsave(paste0(basepath, "scenarios_8_S_sc.pdf"),
       width = 47, height = 17, units = "cm")
...
finalPlot9
# ggsave(paste0(basepath, "map_scenario_9_S_sc.pdf"), width = 30, height = 12, units = "cm")
...
p9
# ggsave(paste0(basepath, "roseplot_scenario_9_S_sc.pdf"), width = 15, height = 15, units = "cm")
...
# ggarrange(map1,p1,map2,p2, map3,p3,ncol = 2, nrow = 3, widths = c(1, 0.5))
# ggsave(paste0(basepath, "scenarios_1-3_S_sc.pdf"),
#        width = 47, height = 50, units = "cm")
#
#
# ggarrange(map4,p4,map5,p5, map6,p6,ncol = 2, nrow = 3, widths = c(1, 0.5))
# ggsave(paste0(basepath, "scenarios_4-6_S_sc.pdf"),
#        width = 47, height = 50, units = "cm")
#
#
# ggarrange(map7,p7,map8,p8, map9,p9,ncol = 2, nrow = 3, widths = c(1, 0.5))
# ggsave(paste0(basepath, "scenarios_7-9_S_sc.pdf"),
#        width = 47, height = 50, units = "cm")
...
ggarrange(map1,map2,map3,
          ...
          map5, map7,map9,
          ncol = 3, nrow = 3)
ggsave(paste0(basepath, "maps_1-9_S_sc_sc.pdf"),
       width = 80, height = 50, units = "cm")
...
ggarrange(p1,p2,p3,
          ...
          p5,p7,p9,
          ncol = 3, nrow = 3)
ggsave(paste0(basepath, "roseplots_1-9_S_sc_sc.pdf"),
       width = 42, height = 42, units = "cm")
