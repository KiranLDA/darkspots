...
load(paste0("C:/Users/kdh10kg/OneDrive - The Royal Botanic Gardens, Kew/darkspots/prep/REV_app_data.RData"))
...
#####Linnean "SR_unknown"
#----------------------------------------------------------------------------
# tdwg3$SR_unknown_norm = scale(tdwg3$SR_unknown, center=F)
tdwg3$SR_unknown_norm_yearly_log = log2(tdwg3$SR_unknown_norm/28)
tdwg3$discoveries_y2010_log = log2(tdwg3$discoveries_y2010)


ggscatter(st_drop_geometry(tdwg3)[rows,], x = "SR_unknown_norm_yearly_log", y = "discoveries_y2010_log",
...
# tdwg3$SR_nogeoloc_norm = scale(tdwg3$SR_nogeoloc, center=F)
tdwg3$SR_nogeoloc_norm_yearly_log =log2(tdwg3$SR_nogeoloc_norm/28)
tdwg3$descriptions_y2010_log = log2(tdwg3$descriptions_y2010)


ggscatter(st_drop_geometry(tdwg3)[rows,], x = "SR_nogeoloc_norm_yearly_log", y = "descriptions_y2010_log",
          add = "reg.line", conf.int = FALSE,
          # yscale = "log2",
          # xscale = "log2",
