...
#   #--------------------------------
#   # UNSCALED / MULTIPLY
#   data[,paste0("benefit_",scenario,"_M")] = normalize_fixed(data$SR_nogeoloc,0,5000) * normalize_fixed(data$SR_unknown,0,2000) * get(paste0("weight_",scenario,"_S"))
#   # normalise(data$shortfalls_norm_index) + get(paste0("weight_",scenario,"_S"))
#   #normalise(normalise(data$SR_nogeoloc) + normalise(data$SR_unknown)) + get(paste0("weight_",scenario,"_S"))#data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
#   data[,paste0("Rank_scenario_",scenario,"_M")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_M")]),
#                                                         na.last = "keep", ties.method = "first")
#
#   #--------------------------------
#   # SCALED / MULTIPLY
#   data[,paste0("benefit_",scenario,"_M_sc")] = normalize_fixed(data$SR_nogeoloc_sc,0,5000) * normalize_fixed(data$SR_unknown_sc,0,2000) * get(paste0("weight_",scenario,"_S"))
#   #normalise(normalise(data$SR_nogeoloc_sc) + normalise(data$SR_unknown_sc)) + get(paste0("weight_",scenario,"_S"))#data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
...
#   #--------------------------------
#   # UNSCALED / log SUM
#   data[,paste0("benefit_",scenario,"_Slog")] = log(data$SR_unknown) + log(data$SR_unknown) +  get(paste0("weight_",scenario,"_S"))
#   # normalise(data$shortfalls_norm_index) + get(paste0("weight_",scenario,"_S"))
#   #normalise(normalise(data$SR_nogeoloc) + normalise(data$SR_unknown)) + get(paste0("weight_",scenario,"_S"))#data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
#   data[,paste0("Rank_scenario_",scenario,"_Slog")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_Slog")]),
#                                                            na.last = "keep", ties.method = "first")
#
#   #--------------------------------
#   # SCALED / log SUM
#   data[,paste0("benefit_",scenario,"_Slog_sc")] = log(data$SR_unknown_sc) + log(data$SR_unknown_sc) + get(paste0("weight_",scenario,"_S"))
#   #normalise(normalise(data$SR_nogeoloc_sc) + normalise(data$SR_unknown_sc)) + get(paste0("weight_",scenario,"_S"))#data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
#   data[,paste0("Rank_scenario_",scenario,"_Slog_sc")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_Slog_sc")]),
#                                                               na.last = "keep", ties.method = "first")
#
#
#
#   #--------------------------------
#   # UNSCALED / log MULTIPLY
#   data[,paste0("benefit_",scenario,"_Mlog")] = log(data$SR_unknown) * log(data$SR_unknown) * get(paste0("weight_",scenario,"_S"))
#   # normalise(data$shortfalls_norm_index) + get(paste0("weight_",scenario,"_S"))
#   #normalise(normalise(data$SR_nogeoloc) + normalise(data$SR_unknown)) + get(paste0("weight_",scenario,"_S"))#data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
#   data[,paste0("Rank_scenario_",scenario,"_Mlog")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_Mlog")]),
#                                                         na.last = "keep", ties.method = "first")
#
#   #--------------------------------
#   # SCALED / log MULTIPLY
#   data[,paste0("benefit_",scenario,"_Mlog_sc")] = log(data$SR_unknown_sc) * log(data$SR_unknown_sc) * get(paste0("weight_",scenario,"_S"))
#   #normalise(normalise(data$SR_nogeoloc_sc) + normalise(data$SR_unknown_sc)) + get(paste0("weight_",scenario,"_S"))#data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
#   data[,paste0("Rank_scenario_",scenario,"_Mlog_sc")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_Mlog_sc")]),
#                                                            na.last = "keep", ties.method = "first")
