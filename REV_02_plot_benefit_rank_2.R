...
df2 = normalise(log(st_drop_geometry(data)[c("SR_nogeoloc_LL", "SR_unknown_sd","SR_nogeoloc","SR_nogeoloc_UL")]+1))
df = df1 + df2
...
df2 = normalise(log(st_drop_geometry(data)[c("SR_nogeoloc_LL_sc","SR_unknown_sd_sc", "SR_nogeoloc_sc","SR_nogeoloc_UL_sc")]+1))
df = df1 + df2
...
weight_1_S = rep(1, length(data$shortfalls_norm_index))
...
for (scenario in 1:9){
  ...
  #--------------------------------
  # UNSCALED / SUM
  data[,paste0("benefit_",scenario,"_S")] = data$shortfalls_norm_index_M + get(paste0("weight_",scenario,"_S"))
  ...
  #--------------------------------
  # UNSCALED / MULTIPLY
  data[,paste0("benefit_",scenario,"_M")] = data$shortfalls_norm_index_M * get(paste0("weight_",scenario,"_M"))
  data[,paste0("Rank_scenario_",scenario,"_M")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_M")]),
                                                   na.last = "keep", ties.method = "first")

  #--------------------------------
  # SCALED / SUM
  data[,paste0("benefit_",scenario,"_S_sc")] = data$shortfalls_norm_index_M_sc + get(paste0("weight_",scenario,"_S"))
  data[,paste0("Rank_scenario_",scenario,"_S_sc")] <- rank(-st_drop_geometry(data[,paste0("benefit_",scenario,"_S_sc")]),
                                                   na.last = "keep", ties.method = "first")

  #--------------------------------
  # SCALED / MULTIPLY
  data[,paste0("benefit_",scenario,"_M_sc")] = data$shortfalls_norm_index_M_sc * get(paste0("weight_",scenario,"_M"))
  ...
  #--------------------------------
  # UNSCALED / SUM
  data[,paste0("benefit_",scenario,"_UL_S")] = data$shortfalls_norm_index_UL + get(paste0("weight_",scenario,"_S"))
  ...
  #--------------------------------
  # UNSCALED / SUM
  data[,paste0("benefit_",scenario,"_LL_S")] = data$shortfalls_norm_index_LL + get(paste0("weight_",scenario,"_S"))
...
MEAN = st_drop_geometry(data$shortfalls_norm_index_M)
...
for (rowi in 1:length(MEAN)){
  randomised_benefits_table[rowi,] = rtruncnorm(n = samples,
                                                ...
                                                mean = st_drop_geometry(data$shortfalls_norm_index_M)[rowi],
  ...
  randomised_benefits_table_sc[rowi,] = rtruncnorm(n = samples,
                                                ...
                                                mean = st_drop_geometry(data$shortfalls_norm_index_M_sc)[rowi],
...
for (scenario in 1:9){
  ...
  #--------------------------------
  # UNSCALED / SUM
  assign(paste0("benefit_table_",scenario,"_S"), sweep(randomised_benefits_table, 1, get(paste0("weight_",scenario,"_S")), FUN = "+" ))
  ...
  temp_in = get(paste0("benefit_table_",scenario,"_S"))

  # rank each column of randomised benefits in table
  for (coli in 1:samples){
    temp_out[,coli] = rank( - temp_in[,coli], na.last = "keep", ties.method = "first")
  }
  assign(paste0("rank_table_",scenario,"_S"), temp_out)

  # calculate the mean rank per country
  mean_rank = NA
  for (rowi in 1:length(MEAN)){
    mean_rank = c(mean_rank, mean(get(paste0("rank_table_",scenario,"_S"))[rowi,]))
  }
  data[,paste0("Rank_rand_scenario_",scenario,"_S")] = mean_rank[-1]
  ...
  mean_rank = NA
  for (rowi in 1:length(MEAN)){
    mean_rank = c(mean_rank, mean(get(paste0("rank_table_",scenario,"_M"))[rowi,]))
  }
  ...
  mean_rank = NA
  for (rowi in 1:length(MEAN)){
    mean_rank = c(mean_rank, mean(get(paste0("rank_table_",scenario,"_S_sc"))[rowi,]))
  }
  ...
  mean_rank = NA
  for (rowi in 1:length(MEAN)){
    mean_rank = c(mean_rank, mean(get(paste0("rank_table_",scenario,"_M_sc"))[rowi,]))
  }
