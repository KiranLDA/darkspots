...
# create map
map1 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_1),
          color = aes(fill = bnf_1),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_1,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_1),
                                                color = aes(fill = bnf_1),#NA,
...
finalPlot1
ggsave(paste0(basepath, "scenario_1.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_1")] %>%
  arrange(LEVEL1_COD, benefit_1)
...
# create map
map2 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_2),
          color = aes(fill = bnf_2),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_2,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_2),
                                                color = aes(fill = bnf_2),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot2
ggsave(paste0(basepath, "scenario_2.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_2")] %>%
  arrange(LEVEL1_COD, benefit_2)
colnames(data) = c("individual","group", "value")
...
# create map
map3 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_3),
          color = aes(fill = bnf_3),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_3,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_3),
                                                color = aes(fill = bnf_3),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot3
ggsave(paste0(basepath, "scenario_3.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_3")] %>%
  arrange(LEVEL1_COD, benefit_3)
colnames(data) = c("individual","group", "value")
...
# create map
map4 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_4),
          color = aes(fill = bnf_4),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_4,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_4),
                                                color = aes(fill = bnf_4),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot4
ggsave(paste0(basepath, "scenario_4.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_4")] %>%
...
# create map
map5 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_5),
          color = aes(fill = bnf_5),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_5,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_5),
                                                color = aes(fill = bnf_5),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot5
ggsave(paste0(basepath, "scenario_5.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_5")] %>%
  arrange(LEVEL1_COD, benefit_5)
colnames(data) = c("individual","group", "value")
...
# create map
map6 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_6),
          color = aes(fill = bnf_6),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_6,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_6),
                                                color = aes(fill = bnf_6),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot6
ggsave(paste0(basepath, "scenario_6.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_6")] %>%
  arrange(LEVEL1_COD, benefit_6)
colnames(data) = c("individual","group", "value")
...
# create map
map7 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_7),
          color = aes(fill = bnf_7),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_7,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_7),
                                                color = aes(fill = bnf_7),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot7
ggsave(paste0(basepath, "scenario_7.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_7")] %>%
  arrange(LEVEL1_COD, benefit_7)
colnames(data) = c("individual","group", "value")
...
# create map
map8 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_8),
          color = aes(fill = bnf_8),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_8,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_8),
                                                color = aes(fill = bnf_8),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot8
ggsave(paste0(basepath, "scenario_8.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_8")] %>%
  arrange(LEVEL1_COD, benefit_8)
colnames(data) = c("individual","group", "value")
...
# create map
map9 <- ggplot() +
  geom_sf(data = data, mapping = aes(fill = bnf_9),
          color = aes(fill = bnf_9),#NA,
          size = 0.4, show.legend = FALSE) +
  geom_sf() +  #+
  geom_point( data= data,
              aes(color =  bnf_9,  #fill = bi_class,
                  geometry = geometry),
              size = 2,
              stat = "sf_coordinates"
  ) +
...
legend <- cowplot::get_legend(ggplot() +geom_sf(data = data, mapping = aes(fill = bnf_9),
                                                color = aes(fill = bnf_9),#NA,
                                                size = 0.4, show.legend = TRUE) +
                                geom_sf() +  #+
                                geom_point( data= data,
...
finalPlot9
ggsave(paste0(basepath, "scenario_9.pdf"), width = 30, height = 12, units = "cm")
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "benefit_9")] %>%
  arrange(LEVEL1_COD, benefit_9)
colnames(data) = c("individual","group", "value")
