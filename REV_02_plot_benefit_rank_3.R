...
for (scenario in 1:9){
  ...
  #--------------------------------
  # UNSCALED / SUM
  data[,paste0("benefit_",scenario,"_S")] = data$shortfalls_norm_index + get(paste0("weight_",scenario,"_S"))
...
MEAN = st_drop_geometry(data$shortfalls_norm_index)
...
for (scenario in 1:9){
  ...
  mean_rank = NA
  for (rowi in 1:length(MEAN)){
    mean_rank = c(mean_rank, mean(get(paste0("rank_table_",scenario,"_S"))[rowi,],na.rm=T))
  }
