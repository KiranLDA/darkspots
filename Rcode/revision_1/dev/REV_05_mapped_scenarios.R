...
load( file = paste0(basepath, "app_data.RData"))
...
darkspots.prj$drk_unprotect = darkspots.prj$benefit_4#darkspots.prj$bnf_4
darkspots.prj$drk = darkspots.prj$benefit_1#darkspots.prj$bnf_1
