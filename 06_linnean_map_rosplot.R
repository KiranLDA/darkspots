...
################################################################
 #SR_nogeoloc_norm
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "SR_unknown_norm")] %>%
  arrange(LEVEL1_COD, SR_unknown_norm)
...
data = tdwg3@data[,c("LEVEL3_NAM","LEVEL1_COD", "SR_nogeoloc_norm")] %>%
  arrange(LEVEL1_COD, SR_nogeoloc_norm)
colnames(data) = c("individual","group", "value")
